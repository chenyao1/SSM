 ...
 */
package org.smartdata.server.command.message;

import java.io.Serializable;
import java.util.List;

public class LaunchCommand implements Serializable {
  private long commandId;
  private List<LaunchAction> launchActions;

  public LaunchCommand(long commandId, List<LaunchAction> launchActions) {
